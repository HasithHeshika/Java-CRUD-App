...
<html lang="en">
  <head>
    ...
    <title>Account Profile - Online Transport System</title>
    ...
    <main class="account-profile-container">
      ...
      <div class="account-sections-wrapper">
        ...
        <section class="profile-section">
          ...
          <form id="profile-form" action="InsertServlet" method="post">
            <div>
              <label for="fullname">Full Name:</label>
              <input type="text" id="fullname" name="fullname" pattern="[A-Za-z\s]+" placeholder="Carl Jhonson" required />
            </div>
            ...
            <div>
              ...
              <input type="tel" id="phone_number" name="phone_number"  pattern="\d{10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);"
       placeholder="0712345678" required />
            ...
            <div>
              ...
              <input type="text" id="pickup_location" name="pickup_location" placeholder="Colombo 03" required />
            </div>
